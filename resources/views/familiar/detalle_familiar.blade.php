    ...
    <div class="min-h-screen bg-slate-50 flex flex-col md:flex-row">
        ...
        <main class="flex-1 p-6 md:p-10 space-y-6">
            ...
            <div class="bg-white border border-slate-200/80 rounded-3xl overflow-hidden shadow-sm p-6 md:p-8 space-y-8">
                ...
                <div>
                    <h2 class="text-lg font-bold text-[#0C3B5E] border-b border-slate-100 pb-2 mb-5">Internos asignados</h2>
                    <div class="space-y-3">
                            ...
                            <p class="text-slate-400 text-sm rounded-xl border border-dashed border-slate-300 p-4 text-center">
                ...
                <div>
                    ...
                    <div class="rounded-xl border border-slate-200 min-h-[120px] p-4 text-sm text-slate-500">
                        @forelse ($familiar->actividades ?? [] as $actividad)
                ...
                <!-- BOTÓN: Desactivar familiar -->
                <div class="pt-2">
                    <form action="" method="POST" onsubmit="return confirm('¿Seguro que quieres desactivar a este familiar?');">
                        @csrf
                        @method('PATCH')
