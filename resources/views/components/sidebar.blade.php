<style>
    ...
    .item-side-bar:hover,
    .item-side-bar.active {
        background-color: #355C7D;
        border-radius: 12px;
    }

    .item-side-bar:hover a,
    .item-side-bar.active a {
        color: white;
    }

    .item-side-bar:hover svg,
    .item-side-bar.active svg {
        color: white;
    }
</style>
<aside class="w-full md:w-64 bg-white border-r border-slate-200/80 p-6 flex-shrink-0">
    <div class="space-y-6">
        ...
        <nav class="space-y-2">     
            <!-- Inicio -->
            <div class="item-side-bar {{ request()->routeIs('dashboard') ? 'active' : '' }}">
            ...
            <!-- Internos  -->
            <div class="item-side-bar {{ request()->routeIs('internos.*') ? 'active' : '' }}">
            ...
            <!-- Cuidadores -->
            <div class="item-side-bar {{ request()->routeIs('cuidadores.*') ? 'active' : '' }}">
            ...
            <!-- Familiares -->
            <div class="item-side-bar {{ request()->routeIs('familiares.*', 'familiar.*') ? 'active' : '' }}">
            ...
            <!-- Incidencias -->
            <div class="item-side-bar {{ request()->routeIs('incidencias.*') ? 'active' : '' }}">
            ...
            <!-- Alertas -->
            <div class="item-side-bar {{ request()->routeIs('alertas.*') ? 'active' : '' }}">
            ...
            <!-- Configuración -->
            <div class="item-side-bar {{ request()->routeIs('profile.*') ? 'active' : '' }}">
