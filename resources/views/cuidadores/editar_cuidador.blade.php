                        ...
                        <div class="space-y-5">
                            <div class="flex gap-4">
                                <div class="flex-1">
                                    ...
                                    <input type="text" name="nombre" value="" class="w-full rounded-xl border-slate-300 shadow-sm focus:border-[#4EBA87] focus:ring focus:ring-[#4EBA87]/20 transition duration-200 text-sm">
                                    @error('nombre') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                                <div class="flex-1">
                                    <label class="block text-sm font-semibold text-slate-700 mb-1">Apellido paterno</label>
                                    <input type="text" name="apellido_paterno" value="" class="w-full rounded-xl border-slate-300 shadow-sm focus:border-[#4EBA87] focus:ring focus:ring-[#4EBA87]/20 transition duration-200 text-sm">
                                    @error('apellido_paterno') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                <div class="flex-1">
                                    ...
                                    <input type="text" name="apellido_materno" value="" class="w-full rounded-xl border-slate-300 shadow-sm focus:border-[#4EBA87] focus:ring focus:ring-[#4EBA87]/20 transition duration-200 text-sm">
                                    @error('apellido_materno') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                                <div class="flex-1">
                                    <label class="block text-sm font-semibold text-slate-700 mb-1">Correo</label>
                                    <input type="email" name="correo" value="" class="w-full rounded-xl border-slate-300 shadow-sm focus:border-[#4EBA87] focus:ring focus:ring-[#4EBA87]/20 transition duration-200 text-sm">
                                    @error('correo') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                            </div>
                            ...
                            <div class="flex gap-4">
                                <div class="flex-1">
                                    ...
                                    <input type="text" name="telefono" value="" class="w-full rounded-xl border-slate-300 shadow-sm focus:border-[#4EBA87] focus:ring focus:ring-[#4EBA87]/20 transition duration-200 text-sm">
                                    @error('telefono') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                                <div class="flex-1">
                                    ...
                                    @error('tipo_cuidador') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-5">
                            <div class="flex gap-4">
                                <div class="flex-1">
                                    ...
                                    <input type="text" name="usuario" value="" class="w-full rounded-xl border-slate-300 shadow-sm focus:border-[#4EBA87] focus:ring focus:ring-[#4EBA87]/20 transition duration-200 text-sm">
                                    @error('usuario') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                                <div class="flex-1">
                                    ...
                                    @error('password') <p class="text-rose-500 text-xs mt-1"></p> @enderror
                                </div>
                            </div>
